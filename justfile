...
[group: "build"]
build-raylib:
    cmake -B build -S . -DCLAY_INCLUDE_ALL_EXAMPLES=OFF -DCLAY_INCLUDE_RAYLIB_EXAMPLES=ON
    cmake --build build

[group: "build"]
build-sdl2:
    cmake -B build -S . -DCLAY_INCLUDE_ALL_EXAMPLES=OFF -DCLAY_INCLUDE_SDL2_EXAMPLES=ON
    cmake --build build

[group: "build"]
build-sdl3:
    cmake -B build -S . -DCLAY_INCLUDE_ALL_EXAMPLES=OFF -DCLAY_INCLUDE_SDL3_EXAMPLES=ON
    cmake --build build

[group: "build"]
build-sokol:
    cmake -B build -S . -DCLAY_INCLUDE_ALL_EXAMPLES=OFF -DCLAY_INCLUDE_SOKOL_EXAMPLES=ON
    cmake --build build

[group: "build"]
build-demos:
    cmake -B build -S . -DCLAY_INCLUDE_ALL_EXAMPLES=OFF -DCLAY_INCLUDE_DEMOS=ON
    cmake --build build
